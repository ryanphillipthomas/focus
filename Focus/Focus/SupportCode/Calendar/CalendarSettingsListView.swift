...
struct CalendarSettingsListView: View {
            ...
            Section(header: Text("Calendar")) {
                if calendarManager.isAuthorized {
                    Button("Refresh Calendars") {
                        AnalyticsManager.shared.logEvent("settings_selection_refresh_calendars")
                        logAndLoadCalendars()
                    }
                } else {
                ...
                NavigationLink("Select Calendar") {
    ...
    private func logAndLoadCalendars() {
        ...
        if calendars.isEmpty {
            ...
            for calendar in calendars {
                ...
                let details = "Calendar: \(calendar.title), Source: \(calendar.source.title), ID: \(calendar.calendarIdentifier), Permissions: \(editable)"
