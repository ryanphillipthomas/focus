...
enum LogType {
    case event, screen, user, startup, generic, health, calendar, authentication, icloud, music, notifications, crash, onboarding, reminders, cache, api, gmail
